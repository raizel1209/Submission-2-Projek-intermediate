...
/**
 * Objek konfigurasi rute aplikasi.
 * Menentukan pemetaan antara path URL dan komponen halaman yang sesuai,
 * dengan penerapan kontrol autentikasi untuk setiap rute.
 */
const routes = {
